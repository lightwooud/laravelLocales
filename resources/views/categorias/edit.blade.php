      ...
      <div class="card-body">
        ...
        <form action="{{ url('/categorias/'.$categoria->id)}}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="description" class="form-control" value="{{old('descripcion', $categoria->description)}} " required>
            </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="estado"  >
                    <option selected disabled> Seleccione el estado </option>
                        <option value="ACTIVO" {{ $categoria->estado == 'ACTIVO' ? 'selected' : '' }} required>ACTIVO</option>
                          <option value="INACTIVO"  {{ $categoria->estado == 'INACTIVO' ? 'selected' : '' }}  required>INACTIVO</option>
                </select>
